...
int main(){
	...
	cout<<"*************BLOOD CIRCULATORY SYSTEM***************\n"<<endl;
	printBloodSystem();
	cout<<"**************RED CELLS TRAVERSE THROUGH BODY IN THEIR LIFE TIME.**************************\n"<<endl;
	redcellTraverse(lifetimeRedcell);
	cout<<"\n************WHITE CELLS TRAVERSE THROUGH BODY IN THEIR LIFE TIME.*******************\n"<<endl;
	whitecellTraverse(lifetimeWhitecell);
	cout<<"\n************PLATELETS TRAVERSE THROUGH BODY IN THEIR LIFE TIME.*************************\n"<<endl;
	plateletTraverse(lifetimePatlets);
	
	while(1){
	cout<<"------------------------------------------------------------------------------\n"<<endl;
	cout<<"1. red cell traverse through body...."<<endl;
	cout<<"2. white cell traverse through body...."<<endl;
	cout<<"3. platelets traverse through body...."<<endl;
	cout<<"4. Exit\n"<<endl;
